...
Some challenges encountered while building the app included learning how to use GitHub authentication, pushing code from VS Code to GitHub, using JavaScript array methods like `filter`, `reduce`, and `sort`, and connecting button event listeners to the correct functions. I also added a search feature as an optional customization.
